...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue')) : typeof define === 'function' && define.amd ? define(['exports', 'vue'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.VueResizableCore = {}, global.Vue));
  ...
  function synchronizeLayoutWithChildren(initialLayout, children, cols, compactType) {
    ...
    children.forEach(function (child, i) {
      ...
      if (exists) {
        ...
        if (g) {
          // @ts-ignore
          layout[i] = cloneLayoutItem(_objectSpread2(_objectSpread2({}, g), {}, {
            i: child.$props.i
          }));
        } else {
    ...
    methods: {
      ...
      resizeHandler: function resizeHandler(handlerName, axis) {
        ...
        return function (_ref4, e) {
          var node = _ref4.node,
              deltaX = _ref4.deltaX,
              deltaY = _ref4.deltaY; // Reset data in case it was left over somehow (should not be possible)
          ...
          var _this$runConstraints2 = _slicedToArray$1(_this$runConstraints, 2);
  ...
  var script = Vue__default['default'].extend({
    name: 'VueGridItem',
    components: {
      VueDraggableCore: VueDraggableCore,
      VueResizableCore: VueResizableCore
    },
    props: {
      cancel: {
        type: String,
    ...
    methods: {
       ...
       */
      dragStart: function dragStart(_ref7, e) {
        var node = _ref7.node;
        var newPosition = {
          top: 0,
          left: 0
        ...
        this.dragging = _objectSpread2({}, newPosition); // Call callback with this data
      ...
      drag: function drag(_ref8, e) {
        ...
        this.dragging = _objectSpread2({}, newPosition); // this.$set(this.dragging, top, newPosition.top);
       ...
       * @param  {Event}  e             event data
       */
      dragStop: function dragStop(_ref9, e) {
        var node = _ref9.node;
       ...
       * @return {Function}           Handler function.
       */
      onResizeHandler: function onResizeHandler(_ref10, e, handlerName) {
        ...
        this.resizing = handlerName === 'resizeStop' ? null : _objectSpread2({}, size);
  ...
  var script$1 = VueGridLayoutProps.extend({
    ...
    methods: {
       ...
       */
      onDragStart: function onDragStart(i, x, y, _ref11) {
        var e = _ref11.e,
            node = _ref11.node;
       ...
       * @param {Element} node The current dragging DOM element
       */
      onDrag: function onDrag(i, x, y, _ref12) {
        var e = _ref12.e,
            node = _ref12.node;
       ...
       * @param {Element} node The current dragging DOM element
       */
      onDragStop: function onDragStop(i, x, y, _ref13) {
        var e = _ref13.e,
            node = _ref13.node;
      ...
      onResizeStart: function onResizeStart(i, w, h, _ref14) {
        var e = _ref14.e,
            node = _ref14.node;
        var currentLayout = this.currentLayout;
        var l = getLayoutItem(currentLayout, i);
      ...
      onResize: function onResize(i, w, h, _ref15) {
        var e = _ref15.e,
            node = _ref15.node;
        var currentLayout = this.currentLayout,
        ...
        if (preventCollision) {
          var collisions = getAllCollisions(currentLayout, _objectSpread2(_objectSpread2({}, l), {}, {
            w: w,
            h: h
      ...
      onResizeStop: function onResizeStop(i, w, h, _ref16) {
        var e = _ref16.e,
            node = _ref16.node;
        var currentLayout = this.currentLayout,
            oldResizeItem = this.oldResizeItem,
      ...
      onDragOver: function onDragOver(e) {
        ...
        if (!this.droppingDOMNode) {
          ...
          this.currentLayout = [].concat(_toConsumableArray(currentLayout), [_objectSpread2(_objectSpread2({}, droppingItem), {}, {
  ...
  var script$2 = VueGridLayoutProps.extend({
    ...
    methods: {
      ...
      onLayoutChange: function onLayoutChange(layout) {
        this.$emit('layoutChange', layout, _objectSpread2(_objectSpread2({}, this.layouts), {}, _defineProperty2({}, this.currentBreakpoint, layout)));
      },
      ...
      onWidthChange: function onWidthChange() {
        ...
        var newLayouts = _objectSpread2({}, this.layouts); // Breakpoint change
